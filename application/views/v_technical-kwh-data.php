	<div class="grid_8 alpha omega tabs">
					...
					<div class="solar-data-tab" id="first" style="display: block;">
						<ul id="kwh-period">
						<li><a class="kwh-period kwh-period-active" href="<?php echo base_url(); ?>technical-solar-data/kwh">Today</a></li>
						<li><a class="kwh-period" href="<?php echo base_url(); ?>technical-solar-data/kwh/week">Week</a></li>
						<li><a class="kwh-period" href="<?php echo base_url(); ?>technical-solar-data/kwh/month">Month</a></li>
						<li><a class="kwh-period" href="<?php echo base_url(); ?>technical-solar-data/kwh/year">Year</a></li>
						<li><a class="kwh-period" href="<?php echo base_url(); ?>technical-solar-data/kwh/since-inception">Since Inception</a></li>
						</ul>
