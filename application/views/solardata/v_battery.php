	<div class="grid_8 alpha omega tabs">
					...
					<ul id="solar-detail-toggle">
						...
						<li><a class="strong" href="<?php echo base_url(); ?>technical-solar-data/batter">Technical Solar Data</a></li>
					</ul>
					<div class="solar-data-tab" id="first" style="display: block;">
						<ul id="period">
						<li><a <?php if (classactive($period, 'day')) { echo 'class="period-active"';} ?> href="<?php echo base_url(); ?>technical-solar-data/battery">Today</a></li>
						<li><a <?php if (classactive($period, 'week')) { echo 'class="period-active"';} ?> href="<?php echo base_url(); ?>technical-solar-data/battery/week">Week</a></li>
						<li><a <?php if (classactive($period, 'month')) { echo 'class="period-active"';} ?> href="<?php echo base_url(); ?>technical-solar-data/battery/month">Month</a></li>
						...
						<li><a <?php if (classactive($period, 'inception')) { echo 'class="period-active"';} ?> href="<?php echo base_url(); ?>technical-solar-data/battery/since_inception">Since Inception</a></li>
						</ul>
				...
				<p class="download"><a target="_blank" href="<?php echo base_url(); ?>technical-solar-data/battery/download">Download spreadsheet of raw data</a></p>
				</div>
