	<div class="grid_8 alpha omega tabs">
					...
					<div class="solar-data-tab" id="first" style="display: block;">
						...
						<li><a class="period-active" href="<?php echo base_url(); ?>technical-solar-data/kwh/week">Week</a></li>
						<li><a class="" href="<?php echo base_url(); ?>technical-solar-data/kwh/month">Month</a></li>
